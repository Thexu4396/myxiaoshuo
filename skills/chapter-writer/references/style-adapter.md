...
## 语言风格基线（冷静观察型）
- ✅ 叙述优先落在可见细节、动作链、表情变化、环境压力和信息偏差上，不抢先替角色下情绪结论
- ✅ 句子保持克制，少用煽动性判断句、抒情排比和作者替读者总结
- ✅ 情绪强度通过反常动作、停顿、视线、措辞变化和决策偏移体现，不靠直白喊情绪
- ✅ 场景观察要带筛选，只写和冲突、关系、风险有关的细节，避免散漫铺陈
- ✅ 允许冷硬、迟疑、审视感，但不要写成木讷流水账，关键变化必须清楚
...
| 叙述声音 | 保持冷静观察，不用作者替角色或读者喊情绪 | 改写为细节、动作、反应 |
